...
//localStore.setItem("parametro","VALOR") - SÓ SALVA "Strings".
// Gravar uma "variavel" chamada nome com o valor "Coxinha". 
...
btnSalvar.addEventListener("click", function(event) {
	...
	criarLinha(form.nome.value, form.qtde.value, form.preco., localStorage.length/3 + 1);
...
for(var i=1; i<=(localStorage.length/3); i=i+1 )
	criarLinha(
